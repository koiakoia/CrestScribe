...
namespace ESI.Model
{
    ...
    public partial class PostCharactersCharacterIdFittingsItem :  IEquatable<PostCharactersCharacterIdFittingsItem>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PostCharactersCharacterIdFittingsItem);
        }

        /// <summary>
        /// Returns true if PostCharactersCharacterIdFittingsItem instances are equal
        /// </summary>
        /// <param name="other">Instance of PostCharactersCharacterIdFittingsItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostCharactersCharacterIdFittingsItem other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
