...
namespace ESI.Model
{
    ...
    public partial class GetCharactersCharacterIdClonesHomeLocation :  IEquatable<GetCharactersCharacterIdClonesHomeLocation>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GetCharactersCharacterIdClonesHomeLocation);
        }

        /// <summary>
        /// Returns true if GetCharactersCharacterIdClonesHomeLocation instances are equal
        /// </summary>
        /// <param name="other">Instance of GetCharactersCharacterIdClonesHomeLocation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetCharactersCharacterIdClonesHomeLocation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
