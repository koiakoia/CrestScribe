...
namespace ESI.Model
{
    ...
    public partial class PostCharactersCharacterIdMailRecipient :  IEquatable<PostCharactersCharacterIdMailRecipient>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PostCharactersCharacterIdMailRecipient);
        }

        /// <summary>
        /// Returns true if PostCharactersCharacterIdMailRecipient instances are equal
        /// </summary>
        /// <param name="other">Instance of PostCharactersCharacterIdMailRecipient to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostCharactersCharacterIdMailRecipient other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
