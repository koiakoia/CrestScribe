...
namespace ESI.Model
{
    ...
    public partial class GetCorporationsCorporationIdIconsOk :  IEquatable<GetCorporationsCorporationIdIconsOk>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GetCorporationsCorporationIdIconsOk);
        }

        /// <summary>
        /// Returns true if GetCorporationsCorporationIdIconsOk instances are equal
        /// </summary>
        /// <param name="other">Instance of GetCorporationsCorporationIdIconsOk to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetCorporationsCorporationIdIconsOk other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
