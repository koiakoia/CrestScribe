...
namespace ESI.Model
{
    ...
    public partial class GetCharactersCharacterIdBookmarksItem :  IEquatable<GetCharactersCharacterIdBookmarksItem>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GetCharactersCharacterIdBookmarksItem);
        }

        /// <summary>
        /// Returns true if GetCharactersCharacterIdBookmarksItem instances are equal
        /// </summary>
        /// <param name="other">Instance of GetCharactersCharacterIdBookmarksItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetCharactersCharacterIdBookmarksItem other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
