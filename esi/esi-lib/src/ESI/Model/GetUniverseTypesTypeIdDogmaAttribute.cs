...
namespace ESI.Model
{
    ...
    public partial class GetUniverseTypesTypeIdDogmaAttribute :  IEquatable<GetUniverseTypesTypeIdDogmaAttribute>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GetUniverseTypesTypeIdDogmaAttribute);
        }

        /// <summary>
        /// Returns true if GetUniverseTypesTypeIdDogmaAttribute instances are equal
        /// </summary>
        /// <param name="other">Instance of GetUniverseTypesTypeIdDogmaAttribute to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetUniverseTypesTypeIdDogmaAttribute other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
