...
namespace ESI.Model
{
    ...
    public partial class GetMarketsStructuresStructureId200Ok :  IEquatable<GetMarketsStructuresStructureId200Ok>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GetMarketsStructuresStructureId200Ok);
        }

        /// <summary>
        /// Returns true if GetMarketsStructuresStructureId200Ok instances are equal
        /// </summary>
        /// <param name="other">Instance of GetMarketsStructuresStructureId200Ok to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetMarketsStructuresStructureId200Ok other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
