...
namespace ESI.Model
{
    ...
    public partial class GetCharactersCharacterIdLocationOk :  IEquatable<GetCharactersCharacterIdLocationOk>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GetCharactersCharacterIdLocationOk);
        }

        /// <summary>
        /// Returns true if GetCharactersCharacterIdLocationOk instances are equal
        /// </summary>
        /// <param name="other">Instance of GetCharactersCharacterIdLocationOk to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetCharactersCharacterIdLocationOk other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
