...
namespace ESI.Model
{
    ...
    public partial class PostFleetsFleetIdMembersInvitation :  IEquatable<PostFleetsFleetIdMembersInvitation>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PostFleetsFleetIdMembersInvitation);
        }

        /// <summary>
        /// Returns true if PostFleetsFleetIdMembersInvitation instances are equal
        /// </summary>
        /// <param name="other">Instance of PostFleetsFleetIdMembersInvitation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostFleetsFleetIdMembersInvitation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
