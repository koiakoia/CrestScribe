...
namespace ESI.Model
{
    ...
    public partial class GetAlliancesAllianceIdIconsOk :  IEquatable<GetAlliancesAllianceIdIconsOk>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GetAlliancesAllianceIdIconsOk);
        }

        /// <summary>
        /// Returns true if GetAlliancesAllianceIdIconsOk instances are equal
        /// </summary>
        /// <param name="other">Instance of GetAlliancesAllianceIdIconsOk to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetAlliancesAllianceIdIconsOk other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
