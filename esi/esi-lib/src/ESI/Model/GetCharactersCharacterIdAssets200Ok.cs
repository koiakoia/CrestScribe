...
namespace ESI.Model
{
    ...
    public partial class GetCharactersCharacterIdAssets200Ok :  IEquatable<GetCharactersCharacterIdAssets200Ok>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GetCharactersCharacterIdAssets200Ok);
        }

        /// <summary>
        /// Returns true if GetCharactersCharacterIdAssets200Ok instances are equal
        /// </summary>
        /// <param name="other">Instance of GetCharactersCharacterIdAssets200Ok to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetCharactersCharacterIdAssets200Ok other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    ...
                    this.IsSingleton.Equals(other.IsSingleton)
                ) && 
                (
                ...
                (
                    this.LocationFlag == other.LocationFlag ||
                    this.LocationFlag != null &&
                    this.LocationFlag.Equals(other.LocationFlag)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.IsSingleton != null)
                    hash = hash * 59 + this.IsSingleton.GetHashCode();
                if (this.ItemId != null)
                    hash = hash * 59 + this.ItemId.GetHashCode();
                if (this.LocationFlag != null)
                    hash = hash * 59 + this.LocationFlag.GetHashCode();
