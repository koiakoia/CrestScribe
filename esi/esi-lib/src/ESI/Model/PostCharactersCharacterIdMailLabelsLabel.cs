...
namespace ESI.Model
{
    ...
    public partial class PostCharactersCharacterIdMailLabelsLabel :  IEquatable<PostCharactersCharacterIdMailLabelsLabel>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PostCharactersCharacterIdMailLabelsLabel);
        }

        /// <summary>
        /// Returns true if PostCharactersCharacterIdMailLabelsLabel instances are equal
        /// </summary>
        /// <param name="other">Instance of PostCharactersCharacterIdMailLabelsLabel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostCharactersCharacterIdMailLabelsLabel other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
