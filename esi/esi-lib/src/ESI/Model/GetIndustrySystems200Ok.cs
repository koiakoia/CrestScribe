...
namespace ESI.Model
{
    ...
    public partial class GetIndustrySystems200Ok :  IEquatable<GetIndustrySystems200Ok>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GetIndustrySystems200Ok);
        }

        /// <summary>
        /// Returns true if GetIndustrySystems200Ok instances are equal
        /// </summary>
        /// <param name="other">Instance of GetIndustrySystems200Ok to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetIndustrySystems200Ok other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    this.CostIndices == other.CostIndices ||
                    this.CostIndices != null &&
                    this.CostIndices.SequenceEqual(other.CostIndices)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CostIndices != null)
                    hash = hash * 59 + this.CostIndices.GetHashCode();
