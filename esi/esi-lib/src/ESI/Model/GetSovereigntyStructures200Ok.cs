...
namespace ESI.Model
{
    ...
    public partial class GetSovereigntyStructures200Ok :  IEquatable<GetSovereigntyStructures200Ok>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GetSovereigntyStructures200Ok);
        }

        /// <summary>
        /// Returns true if GetSovereigntyStructures200Ok instances are equal
        /// </summary>
        /// <param name="other">Instance of GetSovereigntyStructures200Ok to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetSovereigntyStructures200Ok other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.StructureTypeId == other.StructureTypeId ||
                    this.StructureTypeId != null &&
                    this.StructureTypeId.Equals(other.StructureTypeId)
                ) && 
                (
                    this.VulnerabilityOccupancyLevel == other.VulnerabilityOccupancyLevel ||
                    this.VulnerabilityOccupancyLevel != null &&
                    this.VulnerabilityOccupancyLevel.Equals(other.VulnerabilityOccupancyLevel)
                ) && 
                (
                    this.VulnerableEndTime == other.VulnerableEndTime ||
                    this.VulnerableEndTime != null &&
                    this.VulnerableEndTime.Equals(other.VulnerableEndTime)
                ) && 
                (
                    this.VulnerableStartTime == other.VulnerableStartTime ||
                    this.VulnerableStartTime != null &&
                    this.VulnerableStartTime.Equals(other.VulnerableStartTime)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.StructureTypeId != null)
                    hash = hash * 59 + this.StructureTypeId.GetHashCode();
                if (this.VulnerabilityOccupancyLevel != null)
                    hash = hash * 59 + this.VulnerabilityOccupancyLevel.GetHashCode();
                if (this.VulnerableEndTime != null)
                    hash = hash * 59 + this.VulnerableEndTime.GetHashCode();
                if (this.VulnerableStartTime != null)
                    hash = hash * 59 + this.VulnerableStartTime.GetHashCode();
                return hash;
            }
        }
