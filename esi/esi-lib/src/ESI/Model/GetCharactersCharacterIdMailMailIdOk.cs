...
namespace ESI.Model
{
    ...
    public partial class GetCharactersCharacterIdMailMailIdOk :  IEquatable<GetCharactersCharacterIdMailMailIdOk>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GetCharactersCharacterIdMailMailIdOk);
        }

        /// <summary>
        /// Returns true if GetCharactersCharacterIdMailMailIdOk instances are equal
        /// </summary>
        /// <param name="other">Instance of GetCharactersCharacterIdMailMailIdOk to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetCharactersCharacterIdMailMailIdOk other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
