...
namespace ESI.Model
{
    ...
    public partial class GetWarsWarIdDefender :  IEquatable<GetWarsWarIdDefender>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GetWarsWarIdDefender);
        }

        /// <summary>
        /// Returns true if GetWarsWarIdDefender instances are equal
        /// </summary>
        /// <param name="other">Instance of GetWarsWarIdDefender to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetWarsWarIdDefender other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
