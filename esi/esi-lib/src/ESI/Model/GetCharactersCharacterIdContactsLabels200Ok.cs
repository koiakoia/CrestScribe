...
namespace ESI.Model
{
    ...
    public partial class GetCharactersCharacterIdContactsLabels200Ok :  IEquatable<GetCharactersCharacterIdContactsLabels200Ok>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GetCharactersCharacterIdContactsLabels200Ok);
        }

        /// <summary>
        /// Returns true if GetCharactersCharacterIdContactsLabels200Ok instances are equal
        /// </summary>
        /// <param name="other">Instance of GetCharactersCharacterIdContactsLabels200Ok to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetCharactersCharacterIdContactsLabels200Ok other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
