...
namespace ESI.Model
{
    ...
    public partial class GetFleetsFleetIdMembers200Ok :  IEquatable<GetFleetsFleetIdMembers200Ok>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GetFleetsFleetIdMembers200Ok);
        }

        /// <summary>
        /// Returns true if GetFleetsFleetIdMembers200Ok instances are equal
        /// </summary>
        /// <param name="other">Instance of GetFleetsFleetIdMembers200Ok to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetFleetsFleetIdMembers200Ok other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.TakesFleetWarp == other.TakesFleetWarp ||
                    this.TakesFleetWarp != null &&
                    this.TakesFleetWarp.Equals(other.TakesFleetWarp)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TakesFleetWarp != null)
                    hash = hash * 59 + this.TakesFleetWarp.GetHashCode();
                if (this.WingId != null)
