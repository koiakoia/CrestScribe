...
namespace ESI.Model
{
    ...
    public partial class GetIncursions200Ok :  IEquatable<GetIncursions200Ok>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GetIncursions200Ok);
        }

        /// <summary>
        /// Returns true if GetIncursions200Ok instances are equal
        /// </summary>
        /// <param name="other">Instance of GetIncursions200Ok to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetIncursions200Ok other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.HasBoss == other.HasBoss ||
                    this.HasBoss != null &&
                    this.HasBoss.Equals(other.HasBoss)
                ) && 
                (
                    this.InfestedSolarSystems == other.InfestedSolarSystems ||
                    this.InfestedSolarSystems != null &&
                    this.InfestedSolarSystems.SequenceEqual(other.InfestedSolarSystems)
                ) && 
                (
                ...
                (
                    this.StagingSolarSystemId == other.StagingSolarSystemId ||
                    this.StagingSolarSystemId != null &&
                    this.StagingSolarSystemId.Equals(other.StagingSolarSystemId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.HasBoss != null)
                    hash = hash * 59 + this.HasBoss.GetHashCode();
                if (this.InfestedSolarSystems != null)
                    hash = hash * 59 + this.InfestedSolarSystems.GetHashCode();
                if (this.Influence != null)
                    hash = hash * 59 + this.Influence.GetHashCode();
                if (this.StagingSolarSystemId != null)
                    hash = hash * 59 + this.StagingSolarSystemId.GetHashCode();
                if (this.State != null)
