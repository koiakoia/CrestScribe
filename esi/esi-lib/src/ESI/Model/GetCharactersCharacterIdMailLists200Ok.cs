...
namespace ESI.Model
{
    ...
    public partial class GetCharactersCharacterIdMailLists200Ok :  IEquatable<GetCharactersCharacterIdMailLists200Ok>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GetCharactersCharacterIdMailLists200Ok);
        }

        /// <summary>
        /// Returns true if GetCharactersCharacterIdMailLists200Ok instances are equal
        /// </summary>
        /// <param name="other">Instance of GetCharactersCharacterIdMailLists200Ok to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetCharactersCharacterIdMailLists200Ok other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
